...
* **Pimoroni Presto Display (?resto-app/)**
...
|preferred:search{queries:["Sigenergy Open API developer portal base urls"]}| :--- | :--- |
| **Europe (EU)** | `https://api-eu.sigencloud.com` |
| **Australia (AUS)** | bhttps://api-aus.sigencloud.com` |
...
3. Locate your bound station serial number or system code (typically formatted as a string such as `WCYBD1788875121` or `NDXZj1731665796`).
