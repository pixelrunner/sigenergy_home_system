...
system_id = "WCYBD1788875121"
url = f"{base_url}/openapi/systems/{system_id}/summary"

print(f"Querying: {url}")

# Test GET request per documentation specification
try:
...
# Fallback POST test if backend requires JSON body
try:
    res = requests.post(url, headers=headers, json={"systemId": system_id}, timeout=10)
